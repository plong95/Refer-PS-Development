...
public final class Flo {
	...
	public static void enableSnow() {
		final CacheArchive configArchive = Client.instance.streamLoaderForName(2, "config", "config", Client.instance.expectedCRCs[2], 30);
...
//					colour2 = 0xffffff;
//				}
				if (Client.instance.getOption("snow")) {
					colour2 = 0xffffff;
				}
				rgb2hsl(colour2);
			} else if (opcode == 2)
