...
public final class ObjectDef {
	...
	public static ObjectDef forIDOSRS(int i) {
		...
		try {
			switch (i) {
				case 31560:
					objectDef.objectModelIDs = new int[] { 60560 };
					break;
				case 31557:
				case 31558:
					objectDef.objectModelIDs = new int[] { 60566 };
					break;
				case 31569:
					objectDef.objectModelIDs = new int[] { 60565 };
					break;
				case 31561:
					objectDef.objectModelIDs = new int[] { 60567 };
					break;
				case 31563:
					objectDef.objectModelIDs = new int[] { 60568 };
					break;
				case 31570:
					objectDef.objectModelIDs = new int[] { 60564 };
					break;
	...
	private static boolean isOSRSObject(int objectId) {
		if (objectId >= 30283 & objectId <= 30363) {
			return true;
		}
		if (objectId >= 31555 & objectId <= 31570) {
			return true;
		}
	...
	private static final int[] OBJECTS_OSRS = {
			...
			// Kourend
			13705, 13713, 27785, 13712, 11734, 14204, 14205, 14206, 14207, 14208, 14209, 11729, 11731, 7190, 13712,
			27364, 3045, 13450,
			...
			16490, 26760, // 7489, 7493, 7455, 7491, 7459,
			1761, 26300, 2097, 11726, 11735,
	...
	public static ObjectDef forID(int i) {
		...
		if (i == 7455) {// Iron
			ObjectDef wall = ObjectDef.forID(2092);
		...
		if (i == 7489) {// Coal
			ObjectDef wall = ObjectDef.forID(2096);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7491) {// Gold
			ObjectDef wall = ObjectDef.forID(2098);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if(i == 2111) {
			objectDef.name = "Afk-mining";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Mine";
		}

		if(i == 9222) {
			objectDef.name = "Afk-woodcutting";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Chop";
		}
		if (i == 7459) {// Mithril
			ObjectDef wall = ObjectDef.forID(2103);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7493) {// Addy
			ObjectDef wall = ObjectDef.forID(2105);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 1753) {// Yew
			ObjectDef wall = ObjectDef.forID(1309);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 1761) {// Yew
			ObjectDef wall = ObjectDef.forID(1306);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 13035) {
			...
			objectDef.objectModelIDs = new int[] { 95153 };
		}
		if (i == 13661) {
			objectDef.isUnwalkable = true;
			objectDef.hasActions = true;
			...
			objectDef.name = "@or2@Vote Orb";
			//objectDef.objectModelIDs = new int[] { 91642 };
		}
	//	case 7891:
		//		npc.models = new int[] {91642};
		//		npc.name = "";
		...
		if (i == 26426)
			if (i == 26428)
				if (i == 26425)
					if (i == 26427) {
						objectDef.actions = new String[5];
						objectDef.actions[0] = "Open Floor 1";
						objectDef.actions[1] = "Open Floor 2";
					}
		if (i == 2030) {
			objectDef.actions = new String[5];
		...
		if (i == 15000) {
			objectDef.name = "Ethereal Chest";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "open";
			objectDef.objectModelIDs = new int[] { 91642 };
		}
		if (i == 10620) {
			objectDef.name = "WildyWyrm Chest";
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Open";
		}
		if (i == 11356) {
			objectDef.name = "Instanced Training";
		}
		if (i == 47120) {
		...
		switch (i) {
			...
			case 6715:
				...
				case 3422:
				objectDef.name = "@mag@Upgrade Machine";
					objectDef.actions = new String[5];
					objectDef.actions[0] = "Open Upgrade Interface";

					break;

			case 172:
				objectDef.name = "Loot Chest";
				//objectDef.objectModelIDs = new int[] { 71096 };
				break;
			case 4875:
			...
			case 2:
				...
				break;
			case 48676:
				objectDef.name = "Bronze demon statuette";
				objectDef.actions = new String[5];
				objectDef.actions[0] = "Steal from";
				break;
		}
