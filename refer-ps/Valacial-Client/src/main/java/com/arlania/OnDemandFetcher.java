...

{
	...
	public void dumpMaps() {
		...
		for (int i = 0; i < landscapeIds.length; i++) {
			try {
				...
				File map = new File(
						folder.getAbsolutePath() + System.getProperty("file.separator") + landscapeIds[i] + ".gz");
	...
	public final void start(CacheArchive streamLoader,
			Client client) {/*
							 * String crcNames[] = { "model_crc", "anim_crc", "midi_crc", "map_crc",
							 * "image_crc", "texture_crc"
							 * 
							 * };
							 */
		...
		for (int i2 = 0; i2 < mapCount; i2++) {
			...
			if (list.contains(regionIds[i2])) {
				System.out.println("MAP_"+regionIds[i2]+"("+regionIds[i2]+", "+landscapeIds[i2]+", "+objectMapIds[i2]+"),");
			}
		}
		regionIds[90] = 6457;
		landscapeIds[90] = 2300;
		objectMapIds[90] = 2301;
		...
		regionIds[count] = 12701;
		objectMapIds[count] = 3209;
		landscapeIds[count++] = 3208;
		regionIds[count] = 12702;
		objectMapIds[count] = 3205;
		landscapeIds[count++] = 3204;
		regionIds[count] = 12703;
		objectMapIds[count] = 3213;
		landscapeIds[count++] = 3212;
		regionIds[count] = 12957;
		objectMapIds[count] = 3215;
		landscapeIds[count++] = 3214;
		regionIds[count] = 12958;
		objectMapIds[count] = 3211;
		landscapeIds[count++] = 3210;
		regionIds[count] = 12959;
		objectMapIds[count] = 3207;
		landscapeIds[count++] = 3206;
	...
	int[] cheapHaxValues = new int[] { 3627, 3628, 3655, 3656, 3625, 3626, 3629, 3630, 4071, 4072, 5253, 1816, 1817,
			...
			3569, 3570, 3551, 3552, 3579, 3580, 3575, 3576, 3569, 1766, 1767, 3547, 3548, 3682, 3683, 3696, 3697, 3692, 3693,
	...
	public static int objectMapIds[];
	...
	public static int landscapeIds[];
