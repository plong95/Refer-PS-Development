...
public final class TextDrawingArea extends DrawingArea {
	...
	public void method389(boolean flag, int i, int j, String s, int k) {
		...
		if (aBoolean1499)
			DrawingArea.method339(k
					+ (int) ((double) textLineHeight * 0.69999999999999996D),
					0x800000, i - l, l);
	}
	...
	public void drawRegularText(boolean flag1, int i, int j, String s, int k) {
		...
		if (aBoolean1499)
			DrawingArea.drawLine(k + (int) ((double) textLineHeight * 0.69999999999999996D), 0x800000, i - l, l);
	}
