...
//import com.arlania.drpc.RichPresence;
...
//    public static final RichPresence RICH_PRESENCE = new RichPresence();
    ...
    public static AlertHandler alertHandler;
    ...
    public static int getModelZoom(int npcId) {
        switch (npcId) {

            //the higher the return the smaller the npc is
    ...
    private void handleSettings() {
        ...
        if (getOption("snow")) {
            ...
            variousSettings[l2] = 1 - variousSettings[l2];
            RSInterface snowint = RSInterface.interfaceCache[11877];
            if (getOption("snow")) {
                if (!this.parallelWidgetList.contains(snowint)) {
                    parallelWidgetList.add(snowint);
                }
            } else {
                if (this.parallelWidgetList.contains(snowint)) {
                    parallelWidgetList.remove(snowint);
                }
            }
        }
        if (getOption("roofs")) {
    ...
    public void loadSettings() {
        if (!FileOperations.FileExists(signlink.findcachedir()
            ...
            options.put("roofs", false);
            options.put("left_click_att", false);
            options.put("ground_item", true);
            options.put("ctrl_hover", true);
            options.put("snow", false);
            options.put("solid_chatbox", false);
            shadowIndex = 4;
        ...
        try {
            ...
            options.put("roofs", in.readByte() == 1);
            options.put("left_click_att", in.readByte() == 1);
            options.put("ground_item", in.readByte() == 1);
            options.put("ctrl_hover", in.readByte() == 1);
            options.put("snow", in.readByte() == 1);
    ...
    public void saveSettings() {
        try {
            ...
            out.write(getOption("roofs") ? 1 : 0);
            out.write(getOption("left_click_att") ? 1 : 0);
            out.write(getOption("ground_item") ? 1 : 0);
            out.write(getOption("ctrl_hover") ? 1 : 0);
            out.write(getOption("snow") ? 1 : 0);
            out.write(getOption("solid_chatbox") ? 1 : 0);
    ...
    public void rebuildFrame(int size, int width, int height) {
        try {
            ...
            updateGameArea();
            super.mouseWidth = super.mouseHeight = -1;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
                ...
                if (chatMessages[index] != null) {
                    ...
                    if (name != null && name.indexOf("@") == 0) {
                        if (name.contains("@cr10")) {
                            ...
                            ironman2 = 2;
                            fixed = true;
                        } else if (name.contains("@cr15")) {//HERE
                            playerRights = 14;
                            fixed = true;
                        } else if (name.contains("@cr16")) {
                            playerRights = 15;
                            fixed = true;
                        } else if (name.contains("@cr17")) {
                            playerRights = 16;
                            fixed = true;
                        }
...
//								System.out.println("Suppose to draw here: "+playerRights+"");
    ...
    private void clearGroundItemSpawns() {
    ...
    public void processQuickChatArea() {
        ...
        if (super.mouseWidth < 117 && super.mouseHeight > 363) {
            quickHOffsetX = 0;
            quickHoverY2 = -1;
        } else if (super.mouseWidth > 117 && super.mouseWidth < 117 + 158 && super.mouseHeight > 363) {
            quickHOffsetX = 110;
            quickHoverY2 = -1;
        } else {
            quickHOffsetX = 269;
        ...
        if (super.mouseWidth >= 7 && super.mouseWidth <= 23 && super.mouseHeight >= y + 345 && super.mouseHeight <= y + 361) {
            cButtonHPos = 8;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 364
                && super.mouseHeight <= y + 377) {
            quickHoverY = 25;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 378
                && super.mouseHeight <= y + 391) {
            quickHoverY = 39;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 392
                && super.mouseHeight <= y + 405) {
            quickHoverY = 53;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 406
                && super.mouseHeight <= y + 419) {
            quickHoverY = 67;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 420
                && super.mouseHeight <= y + 433) {
            quickHoverY = 81;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 434
                && super.mouseHeight <= y + 447) {
            quickHoverY = 95;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 448
                && super.mouseHeight <= y + 461) {
            quickHoverY = 109;
            inputTaken = true;
        } else if (super.mouseWidth >= 8 + quickHOffsetX && super.mouseWidth <= 117 + quickHOffsetX && super.mouseHeight >= y + 462
                && super.mouseHeight <= y + 474 && shownSelection == 0) {
            quickHoverY = 123;
            inputTaken = true;
        } else {
            quickHoverY = -1;
    ...
    private void processChatModeClick() {
        ...
        if (super.mouseWidth >= x[0] && super.mouseWidth <= x[0] + 56 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 0;
            inputTaken = true;
        } else if (super.mouseWidth >= x[1] && super.mouseWidth <= x[1] + 56 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 1;
            inputTaken = true;
        } else if (super.mouseWidth >= x[2] && super.mouseWidth <= x[2] + 56 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 2;
            inputTaken = true;
        } else if (super.mouseWidth >= x[3] && super.mouseWidth <= x[3] + 56 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 3;
            inputTaken = true;
        } else if (super.mouseWidth >= x[4] && super.mouseWidth <= x[4] + 56 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 4;
            inputTaken = true;
        } else if (super.mouseWidth >= x[5] && super.mouseWidth <= x[5] + 56 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 5;
            inputTaken = true;
        } else if (super.mouseWidth >= x[6] && super.mouseWidth <= x[6] + 56 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 6;
            inputTaken = true;
        } else if (super.mouseWidth >= x[7] && super.mouseWidth <= x[7] + 111 && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            cButtonHPos = 7;
            inputTaken = true;
        } else {
        ...
        if (super.clickMode3 == 1) {
            if (super.saveClickX >= x[0] && super.saveClickX <= x[0] + 56 && super.saveClickY >= clientHeight - 23
                ...
                if (clientSize != 0) {
                    ...
                    && super.saveClickY <= clientHeight) {
                launchURL("http://www.ImaginePS.org");
                pushMessage("We've attempted to open http://ImaginePS.org for you.", 0, "");
            }
            if (!showChat) {
                cButtonCPos = -1;
            }
    ...
    private void rightClickChatButtons() {
        int y = clientHeight - 503;
        int[] x = {5, 62, 119, 176, 233, 290, 347, 404};
        if (super.mouseWidth >= 7 && super.mouseWidth <= 23 && super.mouseHeight >= y + 345
                && super.mouseHeight <= y + 361) {
            if (quickChat) {
        ...
        if (super.mouseWidth >= x[0] && super.mouseWidth <= x[0] + 56
                && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            menuActionName[1] = "View All";
            menuActionID[1] = 999;
            menuActionRow = 2;
        } else if (super.mouseWidth >= x[1] && super.mouseWidth <= x[1] + 56
                && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            ...
            menuActionID[1] = 998;
            menuActionRow = 2;
        } else if (super.mouseWidth >= x[2] && super.mouseWidth <= x[2] + 56
                && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            ...
            menuActionID[5] = 993;
            menuActionRow = 6;
        } else if (super.mouseWidth >= x[3] && super.mouseWidth <= x[3] + 56
                && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
            ...
            menuActionID[4] = 989;
            menuActionRow = 5;
        } else if (super.mouseWidth >= x[4] && super.mouseWidth <= x[4] + 56
                && super.mouseHeight >= clientHeight - 23
                && super.mouseHeight <= clientHeight) {
    ...
    public boolean canClick() {
        ...
        if (showChat || backDialogID != -1) {
            if (super.mouseWidth > 0 && super.mouseWidth < 519 && super.mouseHeight > clientHeight - 165
                    && super.mouseHeight < clientHeight
                    || super.mouseWidth > clientWidth - 220 && super.mouseWidth < clientWidth && super.mouseHeight > 0
                    && super.mouseHeight < 165) {
                return false;
            }
        }
        ...
        if (showTab) {
            if (clientWidth >= smallTabs) {
                if (super.mouseWidth >= clientWidth - 420 && super.mouseWidth <= clientWidth
                        && super.mouseHeight >= clientHeight - 37 && super.mouseHeight <= clientHeight
                        || super.mouseWidth > clientWidth - 204 && super.mouseWidth < clientWidth
                        && super.mouseHeight > clientHeight - 37 - 274 && super.mouseHeight < clientHeight) {
                    return false;
                }
            } else {
                if (super.mouseWidth >= clientWidth - 210 && super.mouseWidth <= clientWidth
                        && super.mouseHeight >= clientHeight - 74 && super.mouseHeight <= clientHeight
                        || super.mouseWidth > clientWidth - 204 && super.mouseWidth < clientWidth
                        && super.mouseHeight > clientHeight - 74 - 274 && super.mouseHeight < clientHeight) {
                    return false;
                }
            }
        }
    ...
    public void addXP(int skillID, long xp) {
        if (canGainXP) {
            if (gains.size() >= 2) {
                gains.clear();
            }
    ...
    public class XPGain {
        ...
        public XPGain(int skill, long xp) {
            this.skill = skill;
            this.xp = xp;
        }
    ...
    public void rightClickMapArea() {
        ...
        if (super.mouseWidth >= clientWidth - (clientSize == 0 ? 0 : 66)
                && super.mouseWidth <= clientWidth
                - (clientSize == 0 ? 0 : 41)
                && super.mouseHeight >= (clientSize == 0 ? 142 : 142)
                && super.mouseHeight <= (clientSize == 0 ? 167 : 167)) {
        ...
        int x = super.mouseWidth; // Face North on compass
        int y = super.mouseHeight;
        ...
        try {
            ...
            if (buttonclicked && inputDialogState == 3) {
                ...
                if (amountOrNameInput.length() == 0) {
                    chatTextDrawingArea.drawCenteredText(0xA05A00, 259, searchingDrops ? "Item drop Search" : "Grand Exchange Item Search", 30 + yPosOffset,
                            false);
    ...
    public void drawClose(int x, int y, int x2, int y2, int x3, int y3) {
        ...
        if (super.mouseWidth >= x2 && super.mouseWidth <= x3 && super.mouseHeight >= y2 && super.mouseHeight <= y3) {
    ...
    public static int getLevelForXP(long exp) {
        int points = 0;
        int output = 0;
        if (exp > 13034430) {
            return 99;
    ...
    private boolean processMenuClick() {
        ...
        if (menuOpen) {
            if (j != 1) {
                int k = super.mouseWidth;
                int j1 = super.mouseHeight;
                if (menuScreenArea == 0) {
                    k -= clientSize == 0 ? 4 : 0;
                    j1 -= clientSize == 0 ? 4 : 0;
                }
...
//        NPCDef.printDefinitionsForId(4419);
                        ...
                        for (width = 0; width < child.width; width++) {
                            ...
                            if (mouseX >= itemX && mouseY >= itemY && mouseX < itemX + 32 && mouseY < itemY + 32) {
                                ...
                                if (child.inv[ptr] > 0) {
                                    ...
                                    if (itemSelected == 1 && child.isInventoryInterface) {
                                        ...
                                        if (child.isInventoryInterface) {
                                            for (int l3 = 4; l3 >= 3; l3--) {
                                                if (itemDef.actions != null && itemDef.actions[l3] != null) {
                                                    if (openInterfaceID != 24700 && openInterfaceID != 47989 && openInterfaceID != 2700) {
                                        ...
                                        if (child.usableItemInterface) {
                                            if (openInterfaceID == 24700) {
                                                ...
                                                menuActionCmd1[menuActionRow] = itemDef.id;
                                                GEItemId = itemDef.id;
                                            } else if (openInterfaceID == 47989) {
                                                menuActionName[menuActionRow] = "Upgrade @lre@" + itemDef.name;
                                        ...
                                        boolean ignoreExamine = child.parentID == 3822 && openInterfaceID == 3824
                                                || openInterfaceID == 2700 || openInterfaceID == 24700 || openInterfaceID == 47989
									...
									if (normDef != null && normDef.actions != null && normDef.actions[1] != null
    ...
    private void updateNPCs(Stream stream, int i) {
        ...
        for (int i1 = 0; i1 < npcCount; i1++) {
            if (npcArray[npcIndices[i1]] == null) {
                ...
                throw new RuntimeException("a problem Happening");
            }
        }
        ...
        try {
            ...
            for (int j = -1; j < playerCount + npcCount; j++) {
                ...
                if (j < playerCount) {
                    ...
                    if (player.headIcon >= 0) {
                        ...
                        if (player.playerRights > 0) {
                            ...
                            if (player.playerRights == 4) {
                                SpriteLoader.sprites[683].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }
                            if (player.playerRights == 13) {
                                SpriteLoader.sprites[689].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 12) {
                                SpriteLoader.sprites[691].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 5) {
                                SpriteLoader.sprites[684].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 6) {
                                SpriteLoader.sprites[685].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 9) {
                                SpriteLoader.sprites[690].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 7) {
                                SpriteLoader.sprites[686].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 8) {
                                SpriteLoader.sprites[687].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 10) {
                                SpriteLoader.sprites[1233].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }

                            if (player.playerRights == 9) {
                                SpriteLoader.sprites[688].drawSprite((spriteDrawX - 8) + x, spriteDrawY - y);
                            }
                    ...
                    if (entityDef_1.elementalIcon == 1) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Fire"), spriteDrawX, spriteDrawY - 10, 0xFF0000, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == 2) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Water"), spriteDrawX, spriteDrawY - 10, 0x0000ff, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == 3) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Earth"), spriteDrawX, spriteDrawY - 10, 0xa52a2a0, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == 4) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Grass"), spriteDrawX, spriteDrawY - 10, 0x008000, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == 5) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Light"), spriteDrawX, spriteDrawY - 10, 0xffff00, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == 6) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Dark"), spriteDrawX, spriteDrawY - 10, 0x000000, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == 7) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Mythical"), spriteDrawX, spriteDrawY - 10, 0xFFA500, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == 8) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString(("Lightning"), spriteDrawX, spriteDrawY - 10, 0xFFA500, 0x000000);
                        }
                    } else if (entityDef_1.elementalIcon == -1) {
                        npcScreenPos(((Entity) (obj)), ((Entity) (obj)).height + 15);
                        if (spriteDrawX > -1) {
                            newSmallFont.drawCenteredString((""), spriteDrawX, spriteDrawY - 10, 0xFFA500, 0x000000);
                        }
                    }
                ...
                if (((Entity) (obj)).loopCycleStatus > loopCycle) {
                    try {
                        ...
                        if (spriteDrawX > -1) {
                        	long hp = entity.currentHealth;
                        	long maxHp = entity.maxHealth;
                        	int hpWidth = (int) (56L * hp / maxHp);
                        	SpriteCache.spriteCache[34].drawSprite(spriteDrawX - 28, spriteDrawY - 5);
                            Sprite s = Sprite. getCutted( SpriteCache.spriteCache[33], hpWidth, SpriteCache.spriteCache[33].myHeight);
    ...
    private void drawMenu() {
        ...
        int j = menuOffsetY;
        int k = menuWidth;
        int j1 = super.mouseWidth;
        int k1 = super.mouseHeight;
        int l = menuHeight + 1;
        int i1 = 0x5d5447;
...
//            RichPresence.initiate();
    ...
    private void drawHpBar() {
        ...
        int maximumEntityHealth2 = maximumEntityHealth;

        maximumEntityHealth2 = maximumEntityHealth2/10;

        String message1 = ""+maximumEntityHealth2;


        if(maximumEntityHealth > 999 && maximumEntityHealth < 1000000 ) {
            maximumEntityHealth2 = maximumEntityHealth / 1000;
            message1 = maximumEntityHealth2+"K";

        } else if(maximumEntityHealth  > 999999) {
            maximumEntityHealth2 = maximumEntityHealth / 1000000;

            message1 = maximumEntityHealth2+"M";

        }

        String message2 = ""+currentEntityHealth;

        int currentEntityHealth2 = currentEntityHealth;


        currentEntityHealth2 = currentEntityHealth2;


        if(currentEntityHealth2 > 1000 && currentEntityHealth2 < 1000000 ) {
            currentEntityHealth2 = currentEntityHealth / 1000;
            message2 = currentEntityHealth2+"K";

        } else if(currentEntityHealth2  > 1000000) {
            currentEntityHealth2 = currentEntityHealth / 1000000;
            message2 = currentEntityHealth2+"M";
        }

        message = message2+"/"+message1;

        newSmallFont.drawCenteredString(message, 63, 52, 0xffffff, 1);
    ...
    public void TargetInformation
            (int positionX, int positionY, String text, String textTwo, int positionXTwo, int positionYTwo) {

        if (text == null)
            return;
        String[] results1 = textTwo.split("\n");
        String[] results = text.split("\n");
        int height = (results.length * 16) + 6;
        width = (results.length * 16) + 6;

        int heightTwo = (results1.length * 12) + 6;
        int widthTwo = (results1.length * 16) + 6;
        ...
        widthTwo = newRegularFont.getTextWidth(results1[0]) + 10;
        for (int i = 1; i < results1.length; i++)
            if (widthTwo <= newRegularFont.getTextWidth(results1[i]) + 6)
                widthTwo = newRegularFont.getTextWidth(results1[i]) + 6;
        int box = widthTwo + 12;
        DrawingArea.drawPixels(height, positionY, positionX, 0x5a5044, width + box);
        DrawingArea.fillPixels(positionX, width + box, height, 0x867560, positionY);
        DrawingArea.drawPixels(heightTwo, positionYTwo, positionXTwo, 0x463d32, widthTwo);
        DrawingArea.fillPixels(positionXTwo, widthTwo, heightTwo, 0x867560, positionYTwo);
        positionY += 14;
        positionYTwo += 14;
        for (int i = 0; i < results.length; i++) {
            normalFont.method389(false, positionX + widthTwo + 6, 9, results[i], positionY);
            positionY += 16;
        }
        for (int i = 0; i < results1.length; i++) {
            normalFont.method389(false, positionXTwo + 5, 9, results1[i], positionYTwo);
            positionYTwo += 16;
        }
    }
	...
	public void drawHintMenu(String itemName, int itemId, int color) {
		int mouseX = Client.instance.mouseWidth;
		int mouseY = Client.instance.mouseHeight;

		if (mouseX > Client.clientWidth - 390) {
			mouseX = Client.clientWidth - 390;
		}
		if (mouseY > Client.clientHeight - 324) {
			mouseY = Client.clientHeight - 324;
		}

		if (controlIsDown) {
			drawStatMenu(itemName, itemId, color, mouseX, mouseY);
		} else if (getOption("ctrl_hover")){
	...
	public static int[][] equipBonuses;
	...
	public void drawStatMenu(String itemName, int itemId, int color, int mouseX, int mouseY){
		int stabAtk = getItemBonuses(itemId)[0];
		...
		DrawingArea.drawBoxOutline(mouseX, mouseY + 5, 150, 150, 0x696969);
		DrawingArea.drawTransparentBox(mouseX + 1, mouseY + 6, 150, 151, 0x000000, 90);
    ...
    private void mainGameProcessor() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
        ...
        for (int d = 0; d < displayAlertDuration.length; d++) {
            if (displayAlertDuration[d] > 0)
                displayAlertDuration[d]--;
        }
        processShadow();
        if (anInt1016 > 0) {
            anInt1016--;
        ...
        if (activeInterfaceType != 0) {
            anInt989++;
            if (super.mouseWidth > anInt1087 + 5 || super.mouseWidth < anInt1087 - 5 || super.mouseHeight > anInt1088 + 5
                    || super.mouseHeight < anInt1088 - 5) {
                aBoolean1242 = true;
            }
            if (super.clickMode2 == 0) {
                ...
                if (aBoolean1242 && anInt989 >= 10) {
                    ...
                    if (anInt1084 == 5382 && super.mouseHeight >= y && super.mouseHeight <= y + 37) {// check
                        // if
                        // bank
                        // interface
                        if (super.mouseWidth >= 28 + x && super.mouseWidth <= 74 + x) {// tab
                            // 1
                        ...
                        if (super.mouseWidth >= 75 + x && super.mouseWidth <= 121 + x) {// tab
                            // 1
                            stream.createFrame(214);
                        ...
                        if (super.mouseWidth >= 122 + x && super.mouseWidth <= 168 + x) {// tab
                            // 2
                            stream.createFrame(214);
                        ...
                        if (super.mouseWidth >= 169 + x && super.mouseWidth <= 215 + x) {// tab
                            // 3
                            stream.createFrame(214);
                        ...
                        if (super.mouseWidth >= 216 + x && super.mouseWidth <= 262 + x) {// tab
                            // 4
                            stream.createFrame(214);
                        ...
                        if (super.mouseWidth >= 263 + x && super.mouseWidth <= 309 + x) {// tab
                            // 5
                            stream.createFrame(214);
                        ...
                        if (super.mouseWidth >= 310 + x && super.mouseWidth <= 356 + x) {// tab
                            // 6
                            stream.createFrame(214);
                        ...
                        if (super.mouseWidth >= 357 + x && super.mouseWidth <= 403 + x) {// tab
                            // 7
                            stream.createFrame(214);
                        ...
                        if (super.mouseWidth >= 404 + x && super.mouseWidth <= 450 + x) {// tab
                            // 8
                            stream.createFrame(214);
	...
	private void parsePackets() {
		long start = System.currentTimeMillis();
		int packetCount = 0;
		while (packetCount++ < 100 && (System.currentTimeMillis() - start) < 19)
			if (!parsePacket())
				return;
	}
    ...
    boolean newplayHover, recoveryHover, loginButtonHover, usernameBarHover, passwordBarHover,
            rememberMeButtonHover, backButtonHover, homeHover, discordHover, youtubeHover;

    public void setLoadingAndLoginHovers() {
        soundHover = newplayHover = recoveryHover = loginButtonHover = usernameBarHover
                = rememberMeButtonHover = backButtonHover = passwordBarHover
                = discordHover = homeHover = youtubeHover = false;

        boolean handCursor = false, textCursor = false;

        if (super.mouseWidth >= clientWidth - 49 - 10 && super.mouseWidth <= clientWidth - 10
                && super.mouseHeight >= clientHeight - 49 - 10 && super.mouseHeight <= clientHeight - 10) {
            soundHover = handCursor = true;
        } else if (loginMessages[0].length() > 0 && super.mouseWidth >= 300
                && super.mouseWidth <= 428 && super.mouseHeight >= 388
                && super.mouseHeight <= 408) {
        ...
        if (!isLoading) {
            width = 265;
            height = 427;
            if (super.mouseWidth >= width && super.mouseWidth <= (width + 243)
                    && super.mouseHeight >= height && super.mouseHeight <= (height + 43)) {
                loginButtonHover = handCursor = true;//Login button.
            }
            //Username bar.
            width = 240;
            height = 255;
            if (super.mouseWidth >= width && super.mouseWidth <= (width + height + 5)
                    && super.mouseHeight >= height && super.mouseHeight <= height + 32) {
                usernameBarHover = textCursor = true;
            }
            //Password bar.
            height = 320;
            if (super.mouseWidth >= width && super.mouseWidth <= (width + height - 60)
                    && super.mouseHeight >= height && super.mouseHeight <= height + 33) {
                passwordBarHover = textCursor = true;
            }
            //Remember me box.
            width = 360;
            height = 368;
            if (super.mouseWidth >= width && super.mouseWidth <= (width + 17)
                    && super.mouseHeight >= height && super.mouseHeight <= (height + 18)) {
            ...
            width = 607;//634
            height = 450;
            if (super.mouseWidth >= width && super.mouseWidth <= (width + 27)
                    && super.mouseHeight >= height && super.mouseHeight <= (height + 24)) {
                youtubeHover = handCursor = true;
            }
    ...
    public CacheArchive streamLoaderForName(int i, String s, String s1, int j, int k) {
        byte abyte0[] = null;
        int l = 5;
        try {
    ...
    private void doAction(int i) {
        ...
        if (l == 24700) {
            ...
            stream.writeByte(searchingDrops ? 0 : 1);
            return;
        }
        if (l == 72667) {
        ...
        if (l == 606) {
            launchURL("http://www.ImaginePS.com");
            pushMessage("We've attempted to open http://www.ImaginePS.com for you.", 0, "");
        }
        if (l == 491) {
        ...
        if (l == 169) {
            ...
            switch (interfaceId) {
                ...
                case 35622:// spec button
                    ...
                    break;
                case 35625:
                    options.put("left_click_att", !getOption("left_click_att"));
                    saveSettings();
                    return;
                case 35616:// hd tex
                ...
                case 35652:
                    options.put("roofs", !getOption("roofs"));
                    saveSettings();
                    return;
                case 35655:
                    options.put("snow", !getOption("snow"));
                    RSInterface snowint = RSInterface.interfaceCache[11877];
                    if (getOption("snow")) {
                        if (!this.parallelWidgetList.contains(snowint)) {
                            parallelWidgetList.add(snowint);
                ...
                case 35574:
                    ...
                    return;
                case 35577:
                    options.put("ground_item", !getOption("ground_item"));
                    saveSettings();
                    return;
                case 35593:
                    ...
                    return;
                case 35596:
                    options.put("ctrl_hover", !getOption("ctrl_hover"));
                    saveSettings();
                    return;
                case 35658:
                    options.put("solid_chatbox", !getOption("solid_chatbox"));
                    saveSettings();
                    return;
            }
        }
    ...
    private void build3dScreenMenu() {
        if (itemSelected == 0 && spellSelected == 0) {
            ...
            if (intersectingWidget() != null) {
                buildInterfaceMenu(4, intersectingWidget(), super.mouseWidth, 4, super.mouseHeight, 0);
            } else if (alertHandler.alert != null) {
                buildInterfaceMenu(4, intersectingWidget(), super.mouseWidth, 4, super.mouseHeight, 0);
            } else {
                menuActionName[menuActionRow] = "Walk here";
                menuActionID[menuActionRow] = 516;
                menuActionCmd2[menuActionRow] = super.mouseWidth;
                menuActionCmd3[menuActionRow] = super.mouseHeight;
                menuActionRow++;
            }
    ...
    private void manageTextInput() {
        do {
            ...
            if (backDialogID == 310 || backDialogID == 306 || backDialogID == 315 || backDialogID == 321
                    ...
                    || backDialogID == 497 || backDialogID == 496) {
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
                ...
                if ((key == 13 || key == 10) && inputString.length() > 0) {
                    ...
                    if (inputString.startsWith("::discord")) {
                        launchURL("https://ImaginePS.org/discord/");
                    }
                    if (inputString.startsWith("::guide")) {
                        launchURL("https://ImaginePS.org/pvm-guide.html/");
                    }
                    if (inputString.startsWith("::launcher")) {
                        launchURL("ImaginePS.org/ImaginePS-Launcher.jar");
                    }
                    if (inputString.startsWith("::client")) {
                        launchURL("ImaginePS.org/client");
                    }
                    if (inputString.startsWith("::forum")) {
                        launchURL("ImaginePS.org/forums");
                    }
                    if (inputString.equals("::donate")) {
                        launchURL("https://ImaginePS.org/store");
                    }

                    if (inputString.equals("::vote")) {
                        launchURL("http://ImaginePS.org/vote");
                    }
    ...
    private void buildItemSearch(int mouseY) {
        ...
        for (int idx = 0; idx < 100; idx++) {
            ...
            if (mouseY > textY - 14 && mouseY <= textY && super.mouseWidth > 74 && super.mouseWidth < 495) {
    ...
    private void drawFriendsListOrWelcomeScreen(RSInterface rsi) {
        ...
        if (j == 14000) {
            this.npcDisplay = NPCDef.forID(rsi.npcDisplay);
            InterfaceNPC petDef = new InterfaceNPC(this.npcDisplay);
            int verticleTilt = 150;
            rsi.modelRotation1 = verticleTilt;
            rsi.modelRotation2 = ((int) (loopCycle / 100.0D * 1024.0D) & 0x7FF);

            Model[] parts = new Model[petDef.getModelArrayLength()];
            ...
            if (this.npcDisplay.originalColours != null && this.npcDisplay.destColours != null) {
                for (int k1 = 0; k1 < this.npcDisplay.originalColours.length; k1++)
                    model.recolour(this.npcDisplay.originalColours[k1], this.npcDisplay.destColours[k1]);
            }
            model.createBones();
        ...
        /*if (j == 3291) {
            ...
            int[] modelArray;
            int animId;
            npcDef = NPCDef.forID(rsi.npcDisplay);
            modelArray = npcDef.models;
            rsi.entityAnim = npcDef.standAnim;
            ...
            for (int i = 0; i < modelArray.length; i++) {
                parts[i] = Model.fetchModel(modelArray[i]);
            }
            Model model;
            if (parts.length == 1) {
                model = parts[0];
            ...
            if (npcDef != null && npcDef.originalColours != null && npcDef.destColours != null) {
                for (int k1 = 0; k1 < npcDef.originalColours.length; k1++)
                    model.recolour(npcDef.originalColours[k1], npcDef.destColours[k1]);
            }
            int colourRedefine = npcDef.colourRedefine;
            int colourRedefine2 = npcDef.colourRedefine2;
            int colourRedefine3 = npcDef.colourRedefine3;
            if (colourRedefine > 0) {
            ...
            NPCDef.applyTexturing(model, npcDef.id);
            model.createBones();
            if (rsi.entityAnim >= 0)
                model.applyTransform(Animation.anims[rsi.entityAnim].frameIDs[rsi.currentFrame]);
            model.light(64, 850, -30, -50, -30, true);
            rsi.mediaType = 5;
            RSInterface.clearModelCache(this.aBoolean994, model);
            return;
                ...
                if ((type == 3 || type == 7)
                    ...
                    if (prefixName != null && prefixName.indexOf("@") == 0) {
                        if (prefixName.contains("@cr10")) {
                            ...
                            ironman2 = 2;
                            fixed = true;
                        } else if (prefixName.contains("@cr15")) {//here
                            rights = 14;
                            fixed = true;
...
//		System.out.println(title);
    ...
    public boolean canClickScreen() {
        ...
        if (super.mouseWidth > 0 && super.mouseHeight > clientHeight - 165 && super.mouseWidth < 519 && super.mouseHeight < clientHeight
                && displayChat
                || super.mouseWidth > clientWidth - 246 && super.mouseHeight > clientHeight - 335 && super.mouseWidth < clientWidth
                && super.mouseHeight < clientHeight
                || super.mouseWidth > clientWidth - 220 && super.mouseHeight > 0 && super.mouseWidth < clientWidth
                && super.mouseHeight < 164
                || (super.mouseWidth > 247 && super.mouseWidth < 260 && super.mouseHeight > clientHeight - 173
                && super.mouseHeight < clientHeight - 166 || super.mouseHeight > clientHeight - 15)
                || super.mouseWidth > clientWidth - 462 && super.mouseHeight > clientHeight - 36 && super.mouseWidth < clientWidth
                && super.mouseHeight < clientHeight) {
            return false;
    ...
    public void processRightClick() {
        ...
        if (clientSize >= 1) {
            if (fullscreenInterfaceID != -1) {
                ...
                buildInterfaceMenu((clientWidth / 2) - 765 / 2, RSInterface.interfaceCache[fullscreenInterfaceID],
                        super.mouseWidth, (clientHeight / 2) - 503 / 2, super.mouseHeight, 0);
        ...
        alertHandler.processMouse(super.mouseWidth, super.mouseHeight);
        ...
        if (clientSize == 0) {
            ...
            if (super.mouseWidth > 0 && super.mouseHeight > 0 && super.mouseWidth < 516 && super.mouseHeight < 338) {
                if (openInterfaceID != -1) {
                    buildInterfaceMenu(4, RSInterface.interfaceCache[openInterfaceID], super.mouseWidth, 4, super.mouseHeight,
                            0);
                } else {
                    build3dScreenMenu();
                }
            ...
            if (canClick()) {
                if (super.mouseWidth > (clientWidth / 2) - 256 && super.mouseHeight > (clientHeight / 2) - 167
                        && super.mouseWidth < ((clientWidth / 2) + 256) && super.mouseHeight < (clientHeight / 2) + 167
                        && openInterfaceID != -1) {
                    buildInterfaceMenu((clientWidth / 2) - 256, RSInterface.interfaceCache[openInterfaceID],
                            super.mouseWidth, (clientHeight / 2) - 167, super.mouseHeight, 0);
                } else {
                    build3dScreenMenu();
                }
            }
        ...
        anInt1315 = 0;
        if (clientSize == 0) {
            if (super.mouseWidth > 516 && super.mouseHeight > 205 && super.mouseWidth < 765 && super.mouseHeight < 466) {
                if (invOverlayInterfaceID != -1) {
                    buildInterfaceMenu(547, RSInterface.interfaceCache[invOverlayInterfaceID], super.mouseWidth, 205,
                            super.mouseHeight, 0);
                } else if (tabInterfaceIDs[tabID] != -1) {
                    buildInterfaceMenu(547, RSInterface.interfaceCache[tabInterfaceIDs[tabID]], super.mouseWidth, 205,
                            super.mouseHeight, 0);
                }
            }
        } else {
            int y = clientWidth >= smallTabs ? 46 : 82;
            if (super.mouseWidth > clientWidth - 197 && super.mouseHeight > clientHeight - y - 245
                    && super.mouseWidth < clientWidth - 7 && super.mouseHeight < clientHeight - y + 10 && showTab) {
                if (invOverlayInterfaceID != -1) {
                    buildInterfaceMenu(clientWidth - 197, RSInterface.interfaceCache[invOverlayInterfaceID],
                            super.mouseWidth, clientHeight - y - 256, super.mouseHeight, 0);
                } else if (tabInterfaceIDs[tabID] != -1) {
        ...
        hoveredInterface = 0;
        anInt1315 = 0;
        if (super.mouseWidth > 0 && super.mouseHeight > (clientSize == 0 ? 338 : clientHeight - 165) && super.mouseWidth < 490
                && super.mouseHeight < (clientSize == 0 ? 463 : clientHeight - 40) && (showChat || backDialogID != -1)) {
            if (backDialogID != -1) {
                buildInterfaceMenu(20, RSInterface.interfaceCache[backDialogID], super.mouseWidth,
                        (clientSize == 0 ? 358 : clientHeight - 145), super.mouseHeight, 0);
            } else if (super.mouseHeight < (clientSize == 0 ? 463 : clientHeight - 40) && super.mouseWidth < 490) {
                buildChatAreaMenu(super.mouseHeight - (clientSize == 0 ? 338 : clientHeight - 165));
            }
        }
        ...
        if (super.mouseWidth > 0 && super.mouseHeight > clientHeight - 165 && super.mouseWidth < 519
                && super.mouseHeight < clientHeight) {
            rightClickChatButtons();
        }
        if (super.mouseWidth > clientWidth - 249 && super.mouseHeight < 168) {
            rightClickMapArea();
        }
    ...
    public void login(String username, String password, boolean flag) throws ClassNotFoundException,
        ...
        try {
            ...
            if (loginCode == 6) {
                loginMessages = new String[]{"ImaginePS is currently being updated.",
                        "Please try again in 60 seconds.."};
                return;
            }
            if (loginCode == 7) {
                loginMessages = new String[]{"ImaginePS is currently busy.", "Please try again."};
                return;
            }
            if (loginCode == 8) {
                loginMessages = new String[]{"ImaginePS login server is down.",
                        "Please try again in 60 seconds.."};
                return;
            }
            if (loginCode == 9) {
            ...
            if (loginCode == 23) {
                loginMessages = new String[]{"ImaginePS is currently being launched.",
                        "Please try again in 60 seconds.."};
                return;
            }
            if (loginCode == 27) {
            ...
            if (loginCode == 30) {
                loginMessages = new String[]{"ImaginePS has been updated!",
    ...
    void startUp() {
         ...
         */
       /* String loadingScreenImage = "bg.png";
        try {
            if (new File(signlink.findcachedir() + loadingScreenImage).exists()) {
                String url = "https://ImaginePS.org/bg.png";
                HttpDownloadUtility.downloadFile(url, signlink.findcachedir());
            }
            loadingSprites[0] = Toolkit.getDefaultToolkit()
                    .getImage(signlink.findcachedir() + loadingScreenImage);

            super.graphics.drawImage(loadingSprites[0], 0, 0, null);
            //super.graphics.drawImage(loadingSprites[1], 5, clientHeight - 35, null);
            //if any issues [0] was [1]
            super.graphics.drawImage(loadingSprites[0], 5, clientHeight - 35, null);
        } catch (Exception e) {
            e.printStackTrace();
        }*/
        /**
        ...
        if(Configuration.REPACK_MODULES) {
            repackCacheIndex(1);
        }
        if(Configuration.REPACK_ANIMATION) {
            repackCacheIndex(2);
        }
        if(Configuration.REPACK_SOUND) {
            repackCacheIndex(3);
        }
        if(Configuration.REPACK_MAPS) {
            repackCacheIndex(4);
        }
        load();
        // refreshClientScreen();
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    BufferedOutputStream gzip = new BufferedOutputStream(new GZIPOutputStream(new FileOutputStream(signlink.findcachedir() + "dump" + cacheIndex + "/" + i + ".dat.gz")));
    ...
    public void load() {
        try {
            ...
            /*
             * Beginning of custom minimap icons //Format: x and y is coords,  Sprite ID is the sprite number in cache
             */
            ...
            customMinimapIcons.add(new CustomMinimapIcon(3382, 9657, new Sprite(mediaArchive, "mapfunction", 34)));
            customMinimapIcons.add(new CustomMinimapIcon(3344, 9657, new Sprite(mediaArchive, "mapfunction", 34)));
            //cooking
            customMinimapIcons.add(new CustomMinimapIcon(3350, 9634, new Sprite(mediaArchive, "mapfunction", 40)));
            //furnace
            customMinimapIcons.add(new CustomMinimapIcon(3350, 9630, new Sprite(mediaArchive, "mapfunction", 9)));
            //mining
            customMinimapIcons.add(new CustomMinimapIcon(3347, 9624, new Sprite(mediaArchive, "mapfunction", 8)));
            customMinimapIcons.add(new CustomMinimapIcon(3358, 9626, new Sprite(mediaArchive, "mapfunction", 8)));
            customMinimapIcons.add(new CustomMinimapIcon(3368, 9626, new Sprite(mediaArchive, "mapfunction", 8)));
            customMinimapIcons.add(new CustomMinimapIcon(3378, 9624, new Sprite(mediaArchive, "mapfunction", 8)));
            //construction
            customMinimapIcons.add(new CustomMinimapIcon(3376, 9646, new Sprite(mediaArchive, "mapfunction", 67)));
            //donator
            customMinimapIcons.add(new CustomMinimapIcon(3363, 9640, new Sprite(mediaArchive, "mapfunction", 70)));
            //hunter
            customMinimapIcons.add(new CustomMinimapIcon(3177, 3941, new Sprite(mediaArchive, "mapfunction", 63)));
            /*
             * End of custom minimap icons
             */
    ...
    private void showErrorScreen() {
        ...
        if (loadingError) {
            ...
            int k = 35;
            g.drawString("Sorry, an error has occured whilst loading ImaginePS", 30, k);
            k += 50;
        ...
        if (genericLoadingError) {
            ...
            g.drawString("To play ImaginePS make sure you play from", 50, 100);
            g.drawString("http://www.ImaginePS.com", 50, 150);
        }
    }
    ...
    private void drawGameScreen() {
        ...
        if (backDialogID == -1 && inputDialogState == 3) {
            ...
            if (super.mouseWidth > 478 && super.mouseWidth < 580 && super.mouseHeight > (clientHeight - 161)) {
                scrollInterface(494, 110, super.mouseWidth - 0, super.mouseHeight - (clientHeight - 155), aClass9_1059, 0, false,
                        totalItemResults);
            }
...
//            System.out.println(Arrays.toString(maxCapeColors));
                    ...
                    if (child.type == 2) {
                                    ...
                                    if (itemSpriteX > DrawingArea.topX - 32 && itemSpriteX < DrawingArea.bottomX
                                        ...
                                        if (sprite_2 != null) {
                                            if (activeInterfaceType != 0 && anInt1085 == spriteIndex
                                                    && anInt1084 == child.id) {
                                                k6 = super.mouseWidth - anInt1087;
                                                j7 = super.mouseHeight - anInt1088;
                                                if (k6 < 5 && k6 > -5) {
                                                    k6 = 0;
                                                }
                                                if (j7 < 5 && j7 > -5) {
                                                ...
                                                if (openInterfaceID == 5292) {
                                                    if (super.mouseHeight >= yy && super.mouseHeight <= yy + 37) {
                                                        bankItemDragSprite = sprite_2;
                                                        bankItemDragSpriteX = super.mouseWidth;
                                                        bankItemDragSpriteY = super.mouseHeight;
                                                    } else {
                                                ...
                                                if (!bankTab) {
                                                    if (k10 >= 1500000000 && child.drawInfinity) {
                                                        ...
                                                        if (k10 > 99999 && k10 < 10000000) {
                                                        	...
                                                        	smallText.drawTransparentText(0xFFFF00, Integer.toString(0), itemSpriteY + 9 + j7, 822,itemSpriteX + k6, 90);
                                                        } else {
                        ...
                        for (int l6 = childY + textDrawingArea.textLineHeight; s
                            ...
                            if (child.centerText) {
                                ...
                                if (child.doubleShadow) {
                                    textDrawingArea.drawRegularTextDoubleShadow(childX + xOffset, color, s1, l6);
                                } else {
                        ...
                        Model model;
                        if (child.mediaType == 5) {
                            NPCDef npcDef = NPCDef.forID(child.mediaID);
                            int frame = animId >= 0 ? Animation.anims[animId].frameIDs[child.currentFrame] : -1;
                            model = npcDef.method164(-1, frame, null, -1, -1, -1);
                        } else if (child.id == 60003) {
                            if (animId == -1) {
                        ...
                        if (canDrawPercent && currentExp[skillIdForButton(child.id)] < 1000000000
                                ...
                                && Skills.goalData[skillIdForButton(child.id)][1] != -1
                                && Skills.goalData[skillIdForButton(child.id)][2] != -1) {
                            long goalPercentage = Skills.goalData[skillIdForButton(child.id)][2];
    ...
    private void readPlayerUpdateMask(int i, int j, Stream stream, Player player) {
        ...
        if ((i & 0x20) != 0) {
            int damage = inStream.readInt();
            int hitmask = stream.readUnsignedByte();
            int icon = stream.readUnsignedByte();
            int soakDamage = inStream.readInt();
            player.updateHitData(hitmask, damage, loopCycle, icon, soakDamage);
            player.loopCycleStatus = loopCycle + 300;
            player.constitution = player.currentHealth = inStream.readInt();
            player.maxConstitution = player.maxHealth = inStream.readInt();
        }
        if ((i & 0x200) != 0) {
            int l1 = inStream.readInt();
    ...
    private void drawParallelWidgets() {
        ...
        for (RSInterface widget : this.parallelWidgetList) {
            if (widget != null) {
                ...
                processInterfaceAnimation(cycleTimer, widget.id);
    ...
    public static int getZoomPercentage() {
        return (int) (clientZoom > 1 ? 100D / clientZoom : (clientZoom == 0 ? 100D : (100 + (1 - clientZoom) * 100D)) / 300);
    }
    ...
    private void draw3dScreen() {
         ...
         */
        if (displayZoomDuration > 0) {
            String zoom = "Zoom: " + getZoomPercentage() + "%";
            int y1 = 16;
            DrawingArea.drawPixelsWithOpacity(16711680, 22, normalFont.getTextWidth(zoom) + 5, y1, 100, 5);
            DrawingArea.drawRectangle(4, y1 + 5, normalFont.getTextWidth(zoom) + 7, y1 + 2, 16739179);
            normalFont.drawRegularText(true, 8, 0xFFFFFF, zoom, 36);
            normalFont.drawRegularText(true, 7, 0xFFFFFF, zoom, 35);
        }
        for (int i = 0; i < displayAlertDuration.length; i++) {
            if (displayAlertDuration[i] > 0) {
                String zoom = alertTitle[i].isEmpty() ? "" : alertTitle[i] + ": " + alertMessage[i];
                int y1 = 16;                      //16711680
                DrawingArea.drawPixelsWithOpacity(16711680, 22 + 16 * i, normalFont.getTextWidth(zoom) + 5, y1, 100, 5);
                // DrawingArea.drawRectangle(4, y1 + 5,
                // smallFont.getTextWidth(zoom) + 7, y1 + 2 + 16 * i, 16739179);
                if (i == 0)
                    DrawingArea.drawHorizontalLine(4, y1 + 5, normalFont.getTextWidth(zoom) + 7, 16739179, true);
                if (i == 4 || displayAlertDuration[i + 1] <= 0)
                    DrawingArea.drawHorizontalLine(4, y1 + 5 + 16 * i + 18, normalFont.getTextWidth(zoom) + 7, 16739179,
                            true);
                if (i == 4 || displayAlertDuration[i + 1] <= 0)
                    DrawingArea.drawVLine(4, y1 + 5, y1 + 3 + 16 * i, 16739179);
                normalFont.drawRegularText(true, 8, 0xFFFFFF, zoom, 36 + 16 * i);
                normalFont.drawRegularText(true, 7, 0xFFFFFF, zoom, 35 + 16 * i);
            }
        }
        if (openInterfaceID == 5292) {
            drawOnBankInterface();
        ...
        if (fpsOn) {
            ...
            k += 15;
            drawingArea.method385(0xffff00, "Mouse X: " + super.mouseWidth + " , Mouse Y: " + super.mouseHeight, 314, 5);
        }
        ...
        if (clientData) {
            ...
            drawingArea.method385(0xffff00, "Mouse X: " + super.mouseWidth + " , Mouse Y: " + super.mouseHeight, 314 - minus, 5);
    ...
    private boolean processInterfaceAnimation(int i, int interfaceId) {
        ...
        for (int childId = 0; childId < rsi.children.length; childId++) {
            ...
            if (child.type == 6 && (child.disabledAnimationId != -1 || child.enabledAnimationId != -1)) {
                ...
                if (child.contentType == 3291) {
                    child.modelRotation1 = 150;
                    child.modelRotation2 = ((int) (loopCycle / 100.0D * 1024.0D) & 0x7FF);
                }
                if (l != -1) {
    ...
    private int extractInterfaceValues(RSInterface rsi, int j) {
        ...
        try {
            ...
            do {
                ...
                if (checkType == 3) {
                    returnValue = (int )currentExp[myValues[valueIdx++]];
                }
                if (checkType == 4) {
    ...
    public void drawTooltip() {
        ...
        if (!s.contains("Walk here") && getOption("tooltip_hover")) {
            ...
            drawHoverBox(super.mouseWidth + (add ? 20 : 10), super.mouseHeight - (add ? 20 : 10), 0x101010, 0xFFFFFF, s);
        }
        if (menuActionRow > 2) {
        ...
        for (int j = 0; j < 100; j++) {
            if (chatMessages[j] != null) {
                ...
                if ((k == 3 || k == 7)
                    ...
                    int l = (clientHeight - 174) - i * 13;
                    if (super.mouseWidth > (clientSize == 0 ? 4 : 0) && super.mouseHeight - (clientSize == 0 ? 4 : 0) > l - 10
                            && super.mouseHeight - (clientSize == 0 ? 4 : 0) <= l + 3) {
                        int i1 = normalFont.getTextWidth("From:  " + name + chatMessages[j]) + 25;
                        if (i1 > 450) {
                            i1 = 450;
                        }
                        if (super.mouseWidth < (clientSize == 0 ? 4 : 0) + i1) {
                            if (myRights >= 1) {
                                menuActionName[menuActionRow] = "Report abuse @whi@" + name;
    ...
    private void connectToUpdateServer() {
        ...
        while (expectedCRCs[8] == 0) {
            ...
            setLoadingText(10, "Connecting to ImaginePS...");
            try {
    ...
    public void drawLoginScreen() {
        ...
        setLoadingAndLoginHovers();
        //Background.
        width = 0;//The lower you go pushes the sprite the West
        height = 0;//The higher you go pushes the sprite North.
        SpriteLoader.sprites[594].drawAdvancedSprite(width, height);
        //Logo.
        width = 86;
        height = 10;
        SpriteLoader.sprites[1295].drawAdvancedSprite(width, height);
        //Login box.
        width = 188;
        height = 165;
        SpriteLoader.sprites[602].drawAdvancedSprite(width, height);
        //Welcome! Logo.
        width = 309;
        height = 180;
        SpriteLoader.sprites[1296].drawAdvancedSprite(width, height);
        //Please enter your credentials Logo.
        width = 242;
        height = 210;
        SpriteLoader.sprites[1297].drawAdvancedSprite(width, height);
        //Username Logo.
//        height = 248;
//        newFancyFont.drawBasicString("Username", width, height, 16777215, 0);
        //SpriteLoader.sprites[1298].drawAdvancedSprite(width, height);
        //Username Bar.
        height = 255;
        SpriteLoader.sprites[597].drawAdvancedSprite(width, height);
        //Password string.
//        height = 313;
//        newFancyFont.drawBasicString("Password", width, height, 16777215, 0);
        //SpriteLoader.sprites[1299].drawAdvancedSprite(width, height);
        //Password bar.
        height = 320;
        SpriteLoader.sprites[597].drawAdvancedSprite(width, height);
        //Remember me? Logo.
        height = 370;
        SpriteLoader.sprites[1300].drawAdvancedSprite(width, height);
        //Remember me box.
        width = 360;
        SpriteLoader.sprites[599].drawAdvancedSprite(width, (height - 3));
        //Login button.
        width = 265;
        height = 420;
        SpriteLoader.sprites[595].drawAdvancedSprite(width, height);
        //Youtube icon.
        height = 415;
        width = 570;
        SpriteLoader.sprites[1301].drawAdvancedSprite(width, height);
        //Discord icon.
        width = width + 40;
        SpriteLoader.sprites[1303].drawAdvancedSprite(width, height);

        if (usernameBarHover) {
            width = 240;
            height = 255;
            SpriteLoader.sprites[598].drawAdvancedSprite(width, height);
        }
        ...
        if (loginButtonHover) {
            width = 265;
            height = 420;
            SpriteLoader.sprites[596].drawAdvancedSprite(width, height);
        }

        if (rememberMe) {
            width = 364;
            height = 364;
            SpriteLoader.sprites[600].drawAdvancedSprite(width, height);
        }
        ...
        width = 570;
        if (youtubeHover) {
            SpriteLoader.sprites[1302].drawAdvancedSprite(width, height);
        }
        width = width + 40;
        if (discordHover) {
            SpriteLoader.sprites[1304].drawAdvancedSprite((width), height);
        }

        if (enableMouseCoords) {
            drawingArea.method385(0xC0C0C0, "Width: " + super.mouseWidth, 314, 5);
            drawingArea.method385(0xC0C0C0, "Height: " + super.mouseHeight, 284, 5);
        }
        ...
        if (loginScreenCursorPos == 0 && loopCycle % 45 < 10) {
            chatTextDrawingArea.drawRegularText(true, width, 16777215, myUsername + "|", height);
        } else {
            chatTextDrawingArea.drawRegularText(true, width, 16777215, myUsername, height);
        }
        ...
        if (loginScreenCursorPos == 1 && loopCycle % 45 < 10) {
            chatTextDrawingArea.drawRegularText(true, width, 16777215, getStars(myPassword) + "|", height);
        } else {
            chatTextDrawingArea.drawRegularText(true, width, 16777215, getStars(myPassword), height);
        }
    ...
    private void processLoginScreenInput() {
        try {
            if (super.clickMode3 == 1) {
                ...
                if (youtubeHover) {
                    launchURL(Configuration.usefulLinks.YOUTUBE.getLink());
                    youtubeHover = discordHover = false;
                }
                if (discordHover) {
                    launchURL(Configuration.usefulLinks.DISCORD.getLink());
                    youtubeHover = discordHover = false;
                }
...
//                    RICH_PRESENCE.updateSmallImageKey(key);
                ...
                case 207:
                    ...
                    int maxHealth = inStream.readInt();
                    int currentHealth = inStream.readInt();
                ...
                case 253:
                    ...
                    if (s1.equals("@CANTADDXP:LOCKED@")) {
                        gains.add(new XPGain(-244, -244));
                        opCode = -1;
                        return true;
                    }

                    if (s1.contains(":gamblereq:")) {
                    ...
                    } else if (s1.contains(":instancereq:")) {
                        String s3 = s1.substring(0, s1.indexOf(":"));
                        long l17 = TextClass.longForName(s3);
                        boolean flag2 = false;
                        for (int j27 = 0; j27 < ignoreCount; j27++) {
                    ...
                    } else if (s1.equalsIgnoreCase("@autocastoff")) {
                        setAutoCastOff();
                        ...
                        boolean clan = s1.startsWith("@clan:A@");
                        if (clan) {
                            s1 = s1.substring(8, s1.length());
                        }
                        pushMessage(s1, clan ? 16 : 0, "");
                    }
                    if (s1.equalsIgnoreCase("oh dear, you are dead!")) {
                        quickPrsActive = false;
                    }
                    opCode = -1;
                    return true;
                ...
                case 126:
                    ...
                    int frame = inStream.readInt();//found the issue kekw
                ...
                case 53:
                    ...
                    try {
                        ...
                        if (rsi_1.contentType == 6060) {
                            rsi_1.frameTimer = 0;
                            rsi_1.scrollPosition = 0;
                            RSInterface parent = RSInterface.interfaceCache[rsi_1.parentID];
                            parent.childX[0] = rsi_1.scrollPosition;
                        }
                    } catch (Exception e) {
...
//                    System.out.println("Interface " + i9);
                    ...
                    while (inStream.currentOffset < pktSize) {
                        ...
                        try {
                            ...
                            System.out.println("Error for interface " + i9);
                        }
                    }
                    opCode = -1;
                    return true;
    ...
    private Object getInputBuffer() {
        // TODO Auto-generated method stub
        return null;
    }

    public static int clientZoom = 2;
    ...
    private void renderWorld() {
        ...
        Model.currentCursorX = super.mouseWidth - 4;
        Model.currentCursorY = super.mouseHeight - 4;
            ...
            for (int y = 0; y < 104; y++) {
                ...
                for (Map.Entry<Integer, Integer> entry : map.entrySet()) {
                    ...
                    if (spriteDrawX > 0 && spriteDrawY > 0) {
                        ItemDef itemDef = ItemDef.forID(entry.getKey());
    ...
    public final String formatAmount(long amount) {
        String format = amount / 1000000000000L + "T";
        if (amount >= 0 && amount < 100000) {
            ...
            format = amount / 1000000000000000L + "Q";
    ...
    public Client() {
        ...
        soundEnabled = true;
        openInterfaceID = -1;
        currentExp = new long[Skills.SKILL_COUNT];
    ...
    public static int[] displayAlertDuration = new int[5];
    public static String[] alertTitle = new String[5];
    public static String[] alertMessage = new String[5];
    public static int displayZoomDuration = 0;
    ...
    public static void setDisplayZoom(boolean setTo) {
        Client.displayZoom = setTo;
        Client.displayZoomDuration = 75;
    }
    ...
    public void drawUpdate(int id, String type) {
        ...
        int minus = 20;
        if (type == "Sell") {
            if (super.mouseWidth >= x && super.mouseWidth <= x + 140 && super.mouseHeight >= y && super.mouseHeight <= y + 110
                    && !menuOpen) {
        ...
        if (name != null) {
            if (name.startsWith("@cr0@") || name.startsWith("@cr1@") || name.startsWith("@cr2@")
                ...
                name = name.substring(5);
                    ...
                    || name.startsWith("@cr13@") || name.startsWith("@Cr14@") || name.startsWith("@Cr15@") || name.startsWith("@Cr16@") || name.startsWith("@Cr17@")) {//HERE
    ...
    public void drawAdv() {
        ...
        if (super.clickMode2 == 1 && super.mouseWidth > 724 && super.mouseWidth < 743 && super.mouseHeight > 1
                && super.mouseHeight < 20) {
            ADVISOR[2].drawSprite(207, 0);
        }
    }

    public boolean mouseInRegion2(int x1, int x2, int y1, int y2) {
        if (super.mouseWidth >= x1 && super.mouseWidth <= x2 && super.mouseHeight >= y1 && super.mouseHeight <= y2) {
            return true;
        }
        return false;
    }
    ...
    public void drawSoak(int damage, int opacity, int drawPos, int x) {
        ...
        smallHit.drawOpacityText(0xffffff, newDmage, drawPos + 32,
    ...
    public void sendConsoleCommand(String command) {
        ...
        switch (commandStart) {
            ...
            case "commands":
                ...
                break;
            case "data":
                if (myUsername.equalsIgnoreCase("")) {
            ...
            case "ddef":
                ItemDef definition = ItemDef.forID(199);
                sendConsoleMessage(definition.modelID + " model id 1", false);
                sendConsoleMessage(definition.maleWearId + " male equip 1", false);
                sendConsoleMessage(definition.maleEquip2 + " male equip 2", false);
                sendConsoleMessage(definition.maleEquip3 + " male equip 3", false);
                sendConsoleMessage(definition.femaleWearId + " fmale equip 1", false);
    ...
    private void saveGoals(String name) {
        try {
            ...
            for (int index = 0; index < Skills.goalData.length; index++) {
                out.writeLong(Skills.goalData[index][0]);
                out.writeLong(Skills.goalData[index][1]);
                out.writeLong(Skills.goalData[index][2]);
    ...
    public static void loadGoals(String name) {
        try {
            ...
            for (int index = 0; index < Skills.goalData.length; index++) {
                Skills.goalData[index][0] = in.readLong();
                Skills.goalData[index][1] = in.readLong();
                Skills.goalData[index][2] = in.readLong();
    ...
    public String setMessage(int skillLevel) {
        ...
        int[] getSkillIds = {0, 3, 14, 2, 16, 13, 1, 15, 10, 4, 17, 7, 5, 12, 11, 6, 9, 8, 20, 18, 19, 21, 22, 23, 24,
                25};
        long init = Skills.goalData[getSkillIds[skillLevel]][0];
        long goal = Skills.goalData[getSkillIds[skillLevel]][1];
        ...
        if ((currentExp[getSkillIds[skillLevel]] < 1000000000) && init > -1 && goal > -1) {
            getToolTipText[4] = ((onNewLine ? "\\n" : "") + Skills.goalType + "" + (Skills.goalType.endsWith("Level: ")
                    ? Long.valueOf(getLevelForXP(goal)) : String.format("%,d", goal)) + "\\n");
            long remainder = goal - currentExp[getSkillIds[skillLevel]] - (Skills.goalType.endsWith("Level: ") ? 1 : 0);
            if (remainder < 0) {
                remainder = 0;
            }
    ...
    boolean enableMouseCoords = Configuration.enableMouseCoords;
